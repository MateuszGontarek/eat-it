...
def test_add_user_controller_has_add_method(capsys: CaptureFixture, payload: dict, controller: AddUserController) -> None:
...
def test_calls_add_in_reposttory_on_calling_controller(controller: AddUserController, repository: UserRepository) -> None:
    request = AddUserRequest(user=payload)
    controller.add(request)
